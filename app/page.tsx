...
import { ArrowRight, MessageCircle, Clock, Zap, BarChart3, CheckCircle2, Sparkles, Star, ChevronDown } from "lucide-react"
...
export default function Home() {
  ...
  const testimonials = [
    { name: "Sarah M.", business: "Luxe Salon", text: "Bookings increased 40% in the first month!", rating: 5 },
    { name: "Mike T.", business: "FitCore Gym", text: "Our front desk staff can finally focus on members.", rating: 5 },
    { name: "Dr. Chen", business: "Wellness Clinic", text: "No-shows reduced by 60% with automated reminders.", rating: 5 },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="relative w-10 h-10 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-500 rounded-xl flex items-center justify-center font-bold text-sm shadow-lg shadow-cyan-500/30 group-hover:shadow-cyan-500/50 transition-all duration-300 group-hover:scale-110">
              <span className="relative z-10">Z</span>
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-300 to-blue-400 rounded-xl blur opacity-0 group-hover:opacity-50 transition-opacity"></div>
            </div>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            <a href="#features" className="text-slate-300 hover:text-cyan-400 transition-colors duration-200">Features</a>
            <a href="#use-cases" className="text-slate-300 hover:text-cyan-400 transition-colors duration-200">Use Cases</a>
            <a href="#testimonials" className="text-slate-300 hover:text-cyan-400 transition-colors duration-200">Testimonials</a>
          </div>

          <Button className="relative bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105 overflow-hidden group">
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 px-6 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className={`relative max-w-7xl mx-auto w-full transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Enhanced Left Content */}
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-full text-sm text-cyan-300 backdrop-blur-sm hover:border-cyan-400/50 transition-colors duration-300 cursor-default group">
                ...
                <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight">
                  ...
                  <span className="relative inline-block">
                    ...
                    <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 rounded-full blur-sm"></div>
                  </span>
                  <br />
                ...
                <p className="text-xl md:text-2xl text-slate-300 leading-relaxed font-light">
                  Zyra automates customer communication and appointment bookings for <span className="text-cyan-400 font-medium">salons, gyms, clinics, and spas</span>.
                  <br />
                  <span className="text-white font-medium">Never miss a booking again.</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                {[
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 group-hover:border-cyan-500/50 rounded-xl p-4 transition-all duration-300 group-hover:scale-105">
                      <stat.icon className="w-5 h-5 text-cyan-400 mb-2 group-hover:rotate-12 transition-transform duration-300" />
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-slate-400 mt-1">Trusted by <span className="text-white font-semibold">500+</span> businesses</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:scale-110">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl rounded-3xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-6 py-4 border-b border-slate-700/50 bg-slate-800/50">
                  ...
                  <div className="flex-1 text-center text-xs text-slate-400 font-medium">Zyra Chat Widget</div>
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 pb-6">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-400 rounded-full border-2 border-slate-900 animate-pulse"></div>
                    </div>
                    <div>
                      <div className="font-semibold text-white text-lg">Zyra Assistant</div>
                  ...
                  <div className="space-y-4 h-80 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-800/50">
                  ...
                  <div className="mt-6 flex gap-3">
                    <input
                      ...
                      disabled
                    />
                    <button className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl px-6 hover:from-cyan-400 hover:to-blue-400 transition-all duration-200 shadow-lg shadow-cyan-500/30">
                      <ArrowRight size={20} />
                    </button>
                  </div>
                </div>
      ...
      <section id="features" className="py-32 px-6 bg-slate-900/50 relative overflow-hidden">
        {/* Background gradient */}
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Everything you need to automate your service business, all in one intelligent platform
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, i) => (
              <div
                key={i}
                className={`group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border rounded-2xl p-8 transition-all duration-500 hover:scale-105 cursor-default ${
                  activeFeature === i ? 'border-cyan-400/50 shadow-xl shadow-cyan-500/20' : 'border-cyan-500/20 hover:border-cyan-500/40'
                }`}
              ...
              >
                ...
                <div className="relative mb-6">
                  <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} blur-xl opacity-30 group-hover:opacity-60 transition-opacity duration-500`}></div>
                  <div className={`relative w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center transform group-hover:rotate-6 transition-all duration-500 shadow-lg`}>
                ...
                {/* Corner accent */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-cyan-500/20 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-6">
            {[
              { icon: Zap, text: "Setup in 5 minutes", subtext: "No technical knowledge required" },
              { icon: CheckCircle2, text: "No code required", subtext: "Simple, intuitive interface" },
              { icon: Sparkles, text: "Free trial included", subtext: "Test before you commit" },
            ].map((item, i) => (
              <div key={i} className="flex items-center gap-4 p-6 bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl hover:border-cyan-500/30 transition-all duration-300 group">
      ...
      <section id="use-cases" className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6">Built for Service Businesses</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { 
                name: "Salons", 
                icon: "💇", 
                features: ["Style bookings", "Staff management", "Product recommendations"],
                gradient: "from-pink-500/20 to-purple-500/20"
              },
              { 
                name: "Gyms", 
                icon: "💪", 
                features: ["Class scheduling", "PT sessions", "Membership queries"],
              ...
              { 
                name: "Spas", 
                icon: "🧘", 
                features: ["Treatment booking", "Package sales", "Gift vouchers"],
                gradient: "from-green-500/20 to-emerald-500/20"
              },
            ].map((useCase, i) => (
              <div
                key={i}
                className="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8 hover:border-cyan-400/50 transition-all duration-500 hover:scale-105 cursor-default overflow-hidden"
              >
                {/* Animated background */}
                ...
                <div className="relative space-y-6">
                  <div className="text-6xl mb-4 group-hover:scale-110 transition-transform duration-300">{useCase.icon}</div>
      ...
      <section id="testimonials" className="py-32 px-6 bg-slate-900/50 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6">Loved by Business Owners</h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <div
                key={i}
                className="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8 hover:border-cyan-400/40 transition-all duration-500 hover:scale-105 cursor-default"
              >
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-500/20 rounded-full blur-3xl animate-pulse"></div>
        </div>
        
        <div className="relative max-w-5xl mx-auto text-center space-y-10">
          <div className="space-y-6">
            <h2 className="text-5xl md:text-7xl font-bold leading-tight">
              Ready to <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">Transform</span> Your Business?
            </h2>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Join <span className="text-white font-bold">500+ service businesses</span> automating their customer communication with Zyra
            </p>
          </div>
      ...
      {/* Enhanced Footer */}
      <footer className="border-t border-slate-800 py-16 px-6 bg-slate-950/80 backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 group cursor-pointer">
                <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-500 rounded-xl flex items-center justify-center font-bold shadow-lg shadow-cyan-500/30 group-hover:shadow-cyan-500/50 transition-all duration-300">
                  Z
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">GDPR</a></li>
              </ul>
            </div>
          </div>

          <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-slate-400 text-sm">© 2025 Zyra. All rights reserved.</p>
