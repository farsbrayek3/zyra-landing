...
export default function Home() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setBookingStep((prev) => (prev < 3 ? prev + 1 : 0));
    }, 2500);
  ...
  const bookingSteps = [
    ...
    },
    {
      ...
      options: ["Sarah - Senior Stylist", "Mike - Color Specialist"],
      icon: "✂️",
    },
    {
      step: 3,
      ...
      options: ["Today 2:00 PM", "Today 4:00 PM"],
      icon: "📅",
    },
    {
      step: 4,
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl rounded-3xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden">
                  {/* Window controls */}
                  <div className="flex items-center gap-2 px-6 py-3 border-b border-slate-700/50 bg-slate-800/50">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 pb-4 border-b border-slate-700/50">
                      <div className="relative">
                        ...
                        <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-400 rounded-full border-2 border-slate-900 animate-pulse" />
                      </div>
                      <div>
                    ...
                    {/* Compact booking steps visualization */}
                    <div className="space-y-3 py-4 min-h-[320px] flex flex-col justify-center">
                      {bookingSteps.slice(0, bookingStep + 1).map((step, i) => (
                        ...
                        >
                          <div
                            className={`rounded-xl px-4 py-2.5 max-w-[85%] shadow-lg ${
                              step.success
                            ...
                            {step.options && (
                              <div className="space-y-1.5 mt-2">
                                {step.options.map((option, idx) => (
                                  <div
                                    key={idx}
                                    className="bg-slate-800/60 border border-slate-600/40 rounded-lg px-3 py-1.5 text-xs text-white hover:border-cyan-500/50 transition-all cursor-pointer hover:bg-slate-800"
                                  >
